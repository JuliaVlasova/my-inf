...
let answers = {
  ...
  whatIsMyName: ['Вас зовут ', 'Если я ничего не путаю, вас зовут '],
  mood: ['А мне нет.', 'Мне тоже, не поверите.', 'А мне-то как!'],
  want: [
    'Я тоже хочу.',
    'А я не хочу.',
    'Ну и что с того?',
    'Не всем желаниям суждено сбыться, дружище.'
  ],
  doesntWant: [
    'А я хочу',
    'И я не хочу',
    'И что вы предлагаете?',
    'Мало ли, что мы не хотим. Надо - значит, надо.'
  ],
  tickling: [
    'Щекотно!',
    'Эй, ну щекотно же!',
