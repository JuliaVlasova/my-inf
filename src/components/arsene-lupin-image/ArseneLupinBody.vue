...
.a-l-inf:hover .eye#left .eyelid#upper {
  width: 31px;
  left: 0px;
}
.a-l-inf:hover .eye#left .eyelid#lower {
  left: -5px;
}
.a-l-inf:hover .eye#right .eyelid#upper {
  width: 30px;
  left: -4px;
}
.a-l-inf:hover .eye#right .eyelid#lower {
  left: 8px;
}
.a-l-inf:hover .eyebrow#left {
  left: 36px;
  top: 28px;
}
.a-l-inf:hover .eyebrow#right {
  left: 81px;
  top: 74px;
}
.a-l-inf:hover .mouth-line {
  border-top-left-radius: 14px 7px;
}
.a-l-inf:hover .head {
  top: 3px;
}
.a-l-inf:hover .ear#right {
  top: 45px;
}
</style>
